...
//				Gio.SettingsBindFlags.DEFAULT);
	...
	_bindSettings: function() {
		this._bindSettingString('position', this._onPositionUpdated);
		//this._onPositionUpdated(this._settings.get_string('position'));
	},
	...
	_onPositionUpdated: function(position) {
